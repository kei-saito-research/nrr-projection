...
\bottomrule
\end{tabular}
\caption{Conditional-first stable cases for \texttt{conditional\_branch} with provider-balanced improvement means. Data from NRR-Boundary \cite{saito2026boundary}; reproduced from existing Boundary results for post hoc reinterpretation, not from new experiments conducted for this paper.}
